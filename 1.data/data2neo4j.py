...
#导入节点 电影信息 Expression in WITH must be aliased (use AS) (line 3, column 6 (offset: 63))
# "WITH line.introduction IS not NULL"
cql='''
LOAD CSV WITH HEADERS  FROM "file:///newmovie.csv" AS line 
